       ...
       <?php include_once('includes/header.php');?>
            ...
            <section class="tables-section">
                ...
                <div class="outer-w3-agile mt-3">
                    <h4 class="tittle-w3-agileits mb-4">View Booking</h4>
...
<div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
     <div class="modal-content">
      <div class="modal-header">
                                  ...
                                  <form method="post" action="/VehicleRental/vrms/admin/controllers/sendSms.php" >
  ...
  <tr>
    ...
    <input name="viewid" type="hidden" value="<?php echo $_REQUEST['viewid']?>" >
    <input name="type" type="hidden" value="twowheeler" >
  </tr>                         
